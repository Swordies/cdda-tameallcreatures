...
- **Healing is area-based.** There's no way to heal one specific tamed monster. The healing cloud affects everything in the area, including wild creatures and you. In this 0.H backport, the engine does not support enchantment-based regeneration; healing incense only heals the player character, not tamed monsters.
